    ...
    render() {
        return (
            <div className="container page">
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'whoweare')}><h3>Who we are:</h3></p>
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'ourvision')}><h3>Our Vision:</h3></p>
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'ourmission')}><h3>Our Mission:</h3></p>
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'ourgoal')}><h3>Our Goal:</h3></p>
                ...
                <h1>FAQ</h1>
                <p className="link" onClick={this.toggleArea.bind(this, 'faqbegin')}><h3>How did Project Pi begin?</h3></p>
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'faqservice')}><h3>How can we trust on your reliability as a service?</h3></p>
                ...
                <p className="link" onClick={this.toggleArea.bind(this, 'faqfree')}><h3>How free is free?</h3></p>
